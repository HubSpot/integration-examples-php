...
<table class="types-list">
    ...
    <?php foreach ($types as $type) { ?>
        <tr>
            <td><a href="/types/show?id=<?php echo $type->id; ?>"><?php echo $type->id; ?></a></td>
            <td><?php echo htmlentities($type->name); ?></td>
            <td><?php echo htmlentities($type->objectType); ?></td>
            <td>
                <a class="button" href="/types/delete?id=<?php echo $type->id; ?>">Delete</a>
            </td>
        </tr>
    <?php }?>
    </tbody>
...
<div>
    <a id='type-new' class="button" href="/types/new">New Types</a>
</div>
